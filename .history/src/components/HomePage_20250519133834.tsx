...
import { Target, Plus, Search, ChevronLeft, ChevronRight, ShieldCheck, CreditCard, Briefcase, UserCircle, BadgeCheck, Menu, X, SlidersHorizontal } from 'lucide-react';
...
export function HomePage() {
  ...
  useEffect(() => {
    ...
    fetchListings();
  }, [selectedCategory, priceRange, locationFilter, conditionFilter]); // Re-fetch when filters change
              ...
              {categories.map(category => (
                ...
                >
                  <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-2 ${
                    ...
                    {/* This is a placeholder for the category icon */}
