    ...
    async function checkDatabase() {
      try {
        ...
        if (error) {
          ...
          // Then map the database structure to what your UI expects
          const mappedListings = data.map(product => ({
            id: product.id,
            title: product.title,
            ...
            image: product.image_url, // Note the mapping from image_url to image
            ...
            seller: {
              ...
              responseRate: product.seller?.response_rate || 0
            }
          }));
