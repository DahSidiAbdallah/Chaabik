      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <div className="relative flex-1 min-w-[180px]">
          <input
            ...
            className="w-full px-4 py-3 pl-12 border border-yellow-200 rounded-lg sm:rounded-l-none focus:outline-none focus:border-yellow-400 focus:ring-1 focus:ring-yellow-400 transition-colors text-gray-900 bg-white placeholder-gray-400"
            value={inputValue}
            onChange={handleInputChange}
            style={{ color: '#1a202c', background: '#fff' }}
          />
          <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
        </div>
        <button 
          type="submit" 
          className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg sm:rounded-l-none font-semibold"
        >
