        ...
        {isMobileMenuOpen && (
          <div className="fixed inset-0 bg-white z-50 flex flex-col items-center justify-center space-y-6">
            ...
            {user ? (
              ...
              <>
                <Link to="/auth" className="text-gray-700 px-4 py-2 rounded-md border border-gray-300 text-lg font-medium hover:bg-gray-50">
                  {t('auth.signUp')}
                </Link>
                <Link to="/auth" className="bg-yellow-400 text-gray-700 px-4 py-2 rounded-md text-lg font-medium hover:bg-yellow-500">
                  {t('auth.signIn')}
                </Link>
              </>
            )}
