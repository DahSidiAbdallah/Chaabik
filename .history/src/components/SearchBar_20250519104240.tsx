      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <div className="relative flex-1">
          <input
            ...
            className="w-full px-4 py-3 pl-12 border border-yellow-200 rounded-lg sm:rounded-l-none focus:outline-none focus:border-yellow-400 focus:ring-1 focus:ring-yellow-400 transition-colors text-gray-800 bg-white"
            value={inputValue}
        ...
        <button 
          type="submit" 
          className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg sm:rounded-l-none"
        >
          {t('search.submit')}
        </button>
      </div>
