  ...
  return (
    <form onSubmit={handleSubmit} className="w-full flex">
      <div className="relative">
        <button
          type="button"
          className="h-12 px-4 bg-yellow-50 text-gray-700 border border-yellow-200 rounded-l-lg hover:bg-yellow-100 focus:outline-none flex items-center gap-2 min-w-[160px]"
      ...
      <button 
        type="submit" 
        className="h-12 px-6 bg-blue-600 hover:bg-blue-700 text-white rounded-r-lg font-semibold border border-blue-600"
