...
export function AddProduct() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Validate main image (optional for lost/found)
      ...
      if (insertError) {
        // Clean up uploaded images if needed
        if (mainImageUrl) await deleteProductImage(mainImageUrl);
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <option value="lost">{t('product.categoryLost')}</option>
                            <option value="found">{t('product.categoryFound')}</option>
                          </select>
