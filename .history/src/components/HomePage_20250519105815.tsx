...
import { Target, Plus, Search, ChevronLeft, ChevronRight, ShieldCheck, CreditCard, Briefcase, UserCircle, BadgeCheck, Menu } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <header className="bg-white py-4 shadow-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          {/* Desktop menu */}
          <div className={`md:flex items-center space-x-8 ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
