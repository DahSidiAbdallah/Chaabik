    ...
    async function checkDatabase() {
      try {
        ...
        if (error) {
          ...
          // If you create tables later, you can query them by uncommenting this code:
          /*
          // Find if there's a listings table
          const hasListingsTable = data?.some(t => t.tablename === 'listings');
          
          if (hasListingsTable) {
            // Query the actual listings table
